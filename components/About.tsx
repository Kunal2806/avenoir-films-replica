...
export default function About() {
    ...
    <h1 className="text-3xl sm:text-4xl md:text-5xl  xl:text-7xl font-semibold font-serif tracking-tighter text-center max-w-5xl">
        Creative-first. Production-smart. No fluff.
    </h1>
    <p className="text-sm sm:text-base md:text-md  tracking-wide sm:tracking-wider text-center max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-4xl leading-relaxed">
